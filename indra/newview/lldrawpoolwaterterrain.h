...
#ifndef LL_LLDRAWPOOLWATERTERRAIN_H
#define LL_LLDRAWPOOLWATERTERRAIN_H

#include "lldrawpool.h"

class LLDrawPoolWaterTerrain : public LLFacePool
{
protected:
...
public:
	...
	LLDrawPoolWaterTerrain();
	/*virtual*/ ~LLDrawPoolWaterTerrain();
